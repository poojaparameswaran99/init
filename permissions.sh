...
#SBATCH --job-name=permissions    # job -name , change from command line 
#SBATCH --mem=200G
...
echo Job Name: permissions

chmod -R g+rwx experimental_data/ init/ misc/ python_envs/ run_utils/ templates/ utils/ rawdata/ tools/ home/ 
